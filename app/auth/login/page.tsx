  ...
  return (
    <div className="max-w-md mx-auto mt-8">
      <div className="border border-lightgray p-8">
        <h1 className="text-2xl font-light mb-6 text-center">Accedi</h1>
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full border border-lightgray py-3 hover:bg-offwhite transition-colors flex items-center justify-center gap-2"
          >
